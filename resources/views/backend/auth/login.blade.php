                            ...
                            <div class="form"> 
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="email" type="text" class="form-control"
                                        placeholder="e.g demoname@domain.com">
                                </div>
                                ...
                                <div class="mb-3 n-chk new-checkbox checkbox-outline-primary">
                                ...
                                <p class="signup-link">Not registered ? <a href="javascript:void(0);">Create an
                                        account</a></p>
