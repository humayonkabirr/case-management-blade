        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu  {{ isActive('admin.index') }}">
                    ...
                    <li class="menu {{ isActive(['admin.role.create', 'admin.role.index']) }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ isActive(['admin.role.create', 'admin.role.index'], 'show') }}" id="role" data-parent="#accordionExample">
                            <li class="{{ isActive('admin.role.index') }}">
                                <a href="{{ route('admin.role.index') }}"> Role Manage </a>
                            </li>
                            <li class="{{ isActive('admin.index') }}">
                                <a href="javascript:void(0);"> Permission Manage </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu {{ isActive(['admin.user.create', 'admin.user.index']) }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ isActive(['admin.user.create', 'admin.user.index'], 'show') }}" id="userManage" data-parent="#accordionExample">
                            <li class="{{ isActive('admin.user.create') }}">
