...
class ActivityLogService
{
    ...
    /**
     * Get a single ActivityLog data by its ID.
     *
     * @param int $id
    ...
    /** 
     *  Update an ActivityLog data by its ID.
     *
     * @param int $id
     * @param array $data
     * @return \App\Models\ActivityLog
    ...
    /**
     * Delete an ActivityLog data by its ID.
     *
     * @param int $id
     * @return bool|null
     */
    ...
    /**
     * Soft delete an ActivityLog data by its ID.
     *
     * @param int $id
     * @return bool|null
     */
    ...
    /**
     * Restore a soft-deleted ActivityLog data by its ID.
     *
     * @param int $id
     * @return bool|null
     */
